...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MPU_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L552ZE_Q_STM32L552XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EMIT_ALL_SYSCALLS, 1);
