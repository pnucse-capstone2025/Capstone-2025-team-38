 ...
 *(.ARM.exidx* gnu.linkonce.armexidx.*)
 ...
 k_object_assignment_area : SUBALIGN(4) { _k_object_assignment_list_start = .; KEEP(*(SORT_BY_NAME(._k_object_assignment.static.*))); _k_object_assignment_list_end = .; } > FLASH
