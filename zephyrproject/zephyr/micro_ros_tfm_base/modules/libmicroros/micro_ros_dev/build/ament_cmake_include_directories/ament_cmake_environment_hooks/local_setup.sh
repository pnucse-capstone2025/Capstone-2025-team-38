...
: ${AMENT_CURRENT_PREFIX:="/home/tmdals010126/zephyrproject/zephyr/micro_ros_tfm_base/modules/libmicroros/micro_ros_dev/install/ament_cmake_include_directories"}
