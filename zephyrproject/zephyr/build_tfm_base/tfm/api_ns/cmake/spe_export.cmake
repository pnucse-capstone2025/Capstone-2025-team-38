...
set(_IMPORT_PREFIX "/home/tmdals010126/zephyrproject/zephyr/build_tfm_base/tfm/api_ns")

# Create imported target tfm_config
add_library(tfm_config INTERFACE IMPORTED)

set_target_properties(tfm_config PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<STREQUAL:,CRYPTO>:PSA_API_TEST_CRYPTO>;\$<\$<STREQUAL:,IPC>:PSA_API_TEST_IPC>;PROJECT_CONFIG_HEADER_FILE=\"/home/tmdals010126/zephyrproject/zephyr/micro_ros_tfm_base/src/configs/config_tfm.h\";TARGET_CONFIG_HEADER_FILE=\"/home/tmdals010126/zephyrproject/modules/tee/tf-m/trusted-firmware-m/config/../platform/ext/target/stm/nucleo_l552ze_q/config_tfm_target.h\";\$<\$<OR:\$<BOOL:ON>,\$<BOOL:0>>:CONFIG_TFM_CONNECTION_POOL_ENABLE>;TFM_PARTITION_LOG_LEVEL=TFM_PARTITION_LOG_LEVEL_INFO;\$<\$<BOOL:ON>:TFM_SP_LOG_RAW_ENABLED>;TFM_PARTITION_CRYPTO;TFM_PARTITION_INITIAL_ATTESTATION;TFM_PARTITION_PROTECTED_STORAGE;TFM_PARTITION_INTERNAL_TRUSTED_STORAGE;TFM_PARTITION_PLATFORM;TFM_PARTITION_NS_AGENT_TZ;\$<\$<STREQUAL:,IPC>:PSA_API_TEST_IPC>;\$<\$<STREQUAL:PSA_ALG_GCM,PSA_ALG_GCM>:PS_CRYPTO_AEAD_ALG_GCM>;\$<\$<STREQUAL:PSA_ALG_GCM,PSA_ALG_CCM>:PS_CRYPTO_AEAD_ALG_CCM>;\$<\$<BOOL:ON>:PS_ENCRYPTION>;CRYPTO_HW_ACCELERATOR"
)
