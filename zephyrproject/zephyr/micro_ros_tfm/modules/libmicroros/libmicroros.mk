...
CFLAGS_INTERNAL := -c -I$(ZEPHYR_BASE)/include/posix -I$(PROJECT_BINARY_DIR)/include/generated -I$(COMPONENT_PATH)/../../../../modules/tee/tf-m/trusted-firmware-m/interface/include -I$(COMPONENT_PATH)/../../../../modules/tee/tf-m/trusted-firmware-m/interface/include/psa -I$(COMPONENT_PATH)/../../src -I$(COMPONENT_PATH)/../../src/configs $(CFLAGS_INTERNAL)
CXXFLAGS_INTERNAL := -c -I$(ZEPHYR_BASE)/include/posix -I$(PROJECT_BINARY_DIR)/include/generated -I$(COMPONENT_PATH)/../../../../modules/tee/tf-m/trusted-firmware-m/interface/include -I$(COMPONENT_PATH)/../../../../modules/tee/tf-m/trusted-firmware-m/interface/include/psa -I$(COMPONENT_PATH)/../../src -I$(COMPONENT_PATH)/../../src/configs $(CXXFLAGS_INTERNAL)
...
$(COMPONENT_PATH)/micro_ros_src/src:
    ...
    touch src/rosidl/rosidl_generator_cpp/COLCON_IGNORE; \
    touch src/rosidl_typesupport/rosidl_typesupport_cpp/COLCON_IGNORE;
...
$(COMPONENT_PATH)/micro_ros_src/install: configure_colcon_meta configure_toolchain $(COMPONENT_PATH)/micro_ros_dev/install $(COMPONENT_PATH)/micro_ros_src/src
	...
	colcon build \
		...
		--cmake-args \
		"--no-warn-unused-cli" \
		-DROSIDL_TYPESUPPORT_SKIP_CPP=ON \
