...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_IMPORT_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PRIVATE_KEY_STATIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 108);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 110000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_OFFSET, 0x41000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_HEAP_SIZE, 32768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_LINK_WITH_MICROROS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_TRANSPORT_SERIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_SERIAL_PORT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_NODES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_PUBLISHERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_SUBSCRIBERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_CLIENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_SERVERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_RMW_HISTORIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_XRCE_DDS_MTU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_XRCE_DDS_HISTORIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_LIBMICROROS_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L552ZE_Q, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_L552ZE_Q_STM32L552XX_NS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_STM32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32L5X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32L552XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_THREAD_PRIORITY, 3);
