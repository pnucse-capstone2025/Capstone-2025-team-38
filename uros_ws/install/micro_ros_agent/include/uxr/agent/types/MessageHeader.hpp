...
class MessageHeader
{
  public:
    ...
    /*!
     * @brief This function sets a value in member nonce
     * @param _nonce New value for member nonce
     */
    inline void nonce(uint32_t _nonce)
    {
        m_nonce = _nonce;
    }

    /*!
     * @brief This function returns the value of member nonce
     * @return Value of member nonce
     */
    ...
    /*!
     * @brief This function returns a reference to member nonce
     * @return Reference to member nonce
     */
     ...
     */
    inline void token(const std::vector<uint8_t> &_token)
    {
        m_token = _token;
    }
     ...
     */
    inline void token(std::vector<uint8_t> &&_token)
    {
     ...
     */
    inline const std::vector<uint8_t> &token() const
    {
        return m_token;
    }
     ...
     */
    inline std::vector<uint8_t> &token()
    {
        return m_token;
    }
