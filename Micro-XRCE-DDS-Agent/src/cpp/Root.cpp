...
uint8_t device_token[256] = {0,};

std::chrono::high_resolution_clock::time_point startTime_1;
std::chrono::high_resolution_clock::time_point startTime_2;
std::chrono::high_resolution_clock::time_point startTime_3;
std::chrono::high_resolution_clock::time_point endTime_1;
std::chrono::high_resolution_clock::time_point endTime_2;
std::chrono::high_resolution_clock::time_point endTime_3;
