...
namespace eprosima
{
    namespace uxr
    {
        ...
        FramingIO::FramingIO(
            ...
            : state_(InputState::UXR_FRAMING_UNINITIALIZED), local_addr_(local_addr), remote_addr_(0), read_buffer_(), read_buffer_head_(0), read_buffer_tail_(0), read_callback_(read_callback), msg_len_(0), msg_pos_(0), msg_crc_(0), cmp_crc_(0), write_buffer_(), write_buffer_pos_(0), write_callback_(write_callback)
        {
        }
