...
public:
    ...
    int32_t nonce_value() const
    {
        return m_nonce_value;
    }

    int32_t hash_value() const
    {
        return m_hash_value;
    }

    void nonce_value(int32_t _nonce_value)
    {
        m_nonce_value = _nonce_value;
    }

    void hash_value(int32_t _hash_value)
    {
        m_hash_value = _hash_value;
    }
...
private:
    ...
    int32_t m_nonce_value;
    int32_t m_hash_value;
};
/*!
